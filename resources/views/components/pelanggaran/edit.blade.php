                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi">{{ old('deskripsi', $pelanggaran->deskripsi) }}</textarea>
                                            @error('deskripsi')
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" class="form-control @error('poin') is-invalid @enderror" id="poin" name="poin" value="{{ old('poin', $pelanggaran->poin) }}">
                                            @error('poin')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-select @error('tipe_pelanggaran_id') is-invalid @enderror" id="tipe_pelanggaran_id" name="tipe_pelanggaran_id">
                                                ...
                                                @foreach ($tipePelanggaran as $tp)
                                                    <option value="{{ $tp->id }}" {{ old('tipe_pelanggaran_id', $pelanggaran->tipe_pelanggaran_id) == $tp->id ? 'selected' : '' }}>{{ $tp->nama }}</option>
                                                @endforeach
                                            </select>
