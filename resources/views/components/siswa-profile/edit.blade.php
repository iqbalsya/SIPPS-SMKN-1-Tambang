                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-select @error('status_parental') is-invalid @enderror" id="status_parental" name="status_parental">
                                                <option value="" disabled>Pilih</option>
                                                <option value="lengkap" {{ old('status_parental', $siswa->status_parental) == 'lengkap' ? 'selected' : '' }}>Lengkap</option>
                                                <option value="yatim" {{ old('status_parental', $siswa->status_parental) == 'yatim' ? 'selected' : '' }}>Yatim</option>
                                                <option value="piatu" {{ old('status_parental', $siswa->status_parental) == 'piatu' ? 'selected' : '' }}>Piatu</option>
                                                <option value="yatim piatu" {{ old('status_parental', $siswa->status_parental) == 'yatim piatu' ? 'selected' : '' }}>Yatim Piatu</option>
                                            </select>
