                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 border-radius-lg">
                            <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                                <h5 class="text-white text-capitalize ps-3">Informasi Siswa : {{ $siswa->nama }}</h5>
                            </div>
                        </div>
                        <div class="container mt-4 mb-4">
                            <div class="row d-flex justify-content-between mt-2">
                                ...
                                <div class="card col-md-4 text-center border-success shadow-lg p-3 mb-3 bg-body rounded" style="max-width: 26rem;">
                                    ...
                                    <a href="{{ route('pelanggaran.create', ['siswa_id' => $siswa->id]) }}" class="btn bg-gradient-danger mb-2">Tambah Pelanggaran</a>
                                </div>
                                <!-- Navigation Tabs -->
                                            ...
                                            <table class="table table-striped mt-3">
                                                ...
                                                <tbody>
                                                    @foreach ($siswa->bukuPelanggarans as $pelanggaran)
                                                        <tr>
                                                            <td class="text-center">{{ $pelanggaran->pivot->hari_tanggal }}</td>
